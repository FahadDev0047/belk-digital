...
hero: {
  ...
  cta: 'Voir Nos Travaux',
  ctaSecondary: 'Voir Nos Services',
  ctaContact: 'Prendre un RDV',
...
expertise: {
  title: 'Création de Chefs-d\'œuvre Numériques',
  learnDetails: 'VOIR LES DÉTAILS',
  journey: 'PRÊT À COMMENCER VOTRE VOYAGE ?',
  cta: 'Discutons',
},
services: {
  ...
  heroPart1: 'Services web et SEO pour une',
  heroItalic: 'croissance',
  heroPart2: 'commerciale globale.',
  heroSubtitle: 'Nous fournissons des services numériques de bout en bout qui aident les entreprises aux États-Unis, en Europe, dans le CCG et en Australie à construire, optimiser et faire évoluer des plateformes numériques performantes.',
...
about: {
  ...
  hero: {
    ...
    badge: 'Depuis 2015',
    heroPart1: 'Nous vous aidons à créer un',
    heroItalic: 'impact durable',
    heroPart2: 'en ligne.',
    heroSubtitle: 'Nous sommes là pour créer bien plus qu\'un simple site web — notre mission est de vous aider à construire une expérience numérique qui connecte, engage et génère de véritables résultats pour votre entreprise.',
  },
  mission: {
  ...
  whoWeWorkWith: {
    ...
    headingPart1: 'Avec Qui Nous',
    headingItalic: 'Travaillons',
    headingPart2: '',
    chapter: 'Chapitre',
    items: [
      {
  ...
  team: {
    badge: 'NOTRE ÉQUIPE',
    titlePart1: 'Vous aider à faire un',
    titleItalic: 'impact durable',
    titlePart2: 'en ligne.',
...
terms: {
  ...
  homeProjects: {
    ...
    titlePart1: 'Projets',
    titlePart2: 'phares',
    subtitle: 'Une sélection de projets sur lesquels j\'ai travaillé, de la conception au lancement.',
    explore: 'Voir tous les travaux',
    cardView: 'Voir',
  ...
  homeJournal: {
    ...
    blog: 'BLOG',
    articles: [
      { title: "101: Créer une marque mémorable" },
      { title: "102: L'avenir des produits digitaux" },
      { title: "103: Améliorer l'expérience utilisateur" }
    ]
  },
  homeWorkTogether: {
  ...
  homeLocations: {
    badge: 'PORTÉE MONDIALE',
    titlePart1: 'Nous Opérons dans le',
    titlePart2: 'Monde Entier',
    subtitle: 'Stratégiquement positionnés dans six régions pour servir nos clients au bon moment, dans la bonne langue et sur le bon canal.',
    explore: 'Voir Toutes les Localisations',
    cardView: 'Visiter',
    items: [
      { country: 'États-Unis', code: 'US', cities: ['New York', 'Los Angeles'], slug: 'usa' },
      { country: 'Émirats Arabes Unis', code: 'UAE', cities: ['Dubaï', 'Abou Dabi'], slug: 'uae' },
      { country: 'Arabie Saoudite', code: 'KSA', cities: ['Riyad', 'Djeddah'], slug: 'ksa' },
      { country: 'Royaume-Uni', code: 'UK', cities: ['Londres', 'Manchester'], slug: 'europe' },
