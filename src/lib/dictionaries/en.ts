const translations = {
  seo: {
    ...
    work: {
      title: 'Our Work | Digital Success Stories',
      description: 'Explore our portfolio of delivered projects. From custom websites to complex web applications, see how we help businesses grow.'
    },
    privacy: {
  ...
  expertise: {
    ...
    journey: 'READY TO START YOUR JOURNEY?',
    cta: 'Let\'s Talk',
  },
  // Services
  services: {
    ...
    heroPart1: 'Global web, saas & seo for',
    heroItalic: 'scalable',
    heroPart2: 'business growth.',
    heroSubtitle: 'We deliver end-to-end digital services that help businesses in the US, Europe, GCC, and Australia build, optimize, and scale high-performance digital platforms.',
  ...
  about: {
    ...
    hero: {
      ...
      heroPart1: 'Helping you make a',
      heroItalic: 'lasting',
      heroPart2: 'impact online.',
      heroSubtitle: 'We’re here to craft more than just a website—our mission is to help you build a digital experience that connects, engages, and drives real results for your business.',
    },
    mission: {
    ...
    team: {
      badge: 'OUR TEAM',
      titlePart1: 'Helping you make a',
      titleItalic: 'lasting impact',
      titlePart2: 'online.',
  ...
  homeProjects: {
    ...
    items: [
      { title: 'Automotive Motion', year: '2024', tags: ['CGI Motion', 'Strategy', 'Design'], image: '/images/projects/automotive-motion.png' },
      { title: 'Urban Architecture', year: '2024', tags: ['3D Viz', 'Brand Identity', 'Product'], image: '/images/projects/urban-architecture.png' },
      { title: 'Human Perspective', year: '2023', tags: ['Photography', 'UI/UX', 'Art'], image: '/images/projects/human-perspective.png' },
  ...
  homeJournal: {
    ...
    blog: 'BLOG',
    articles: [
      { title: "101: Crafting a Memorable Brand Mark" },
      { title: "102: The Future of Digital Products" },
      { title: "103: Elevating Experiences" }
    ]
  },
  homeWorkTogether: {
  ...
  homeLocations: {
    badge: 'GLOBAL REACH',
    titlePart1: 'We Operate',
    titlePart2: 'Worldwide',
    subtitle: 'Strategically positioned across six regions to serve clients at the right time, in the right language, on the right channel.',
    explore: 'View All Locations',
    cardView: 'Visit',
    items: [
      { country: 'United States', code: 'US', cities: ['New York', 'Los Angeles'], slug: 'usa' },
      { country: 'United Arab Emirates', code: 'UAE', cities: ['Dubai', 'Abu Dhabi'], slug: 'uae' },
      { country: 'Saudi Arabia', code: 'KSA', cities: ['Riyadh', 'Jeddah'], slug: 'ksa' },
      { country: 'United Kingdom', code: 'UK', cities: ['London', 'Manchester'], slug: 'europe' },
      { country: 'Australia', code: 'AU', cities: ['Sydney', 'Melbourne'], slug: 'australia' },
      { country: 'India', code: 'IN', cities: ['Mumbai', 'Bangalore', 'Delhi'], slug: '' }
    ]
  },
  numbersSection: {
    items: [
