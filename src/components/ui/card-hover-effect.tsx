                ...
                const cardContent = (
                    ...
                    >
                        <AnimatePresence>
                            {hoveredIndex === idx && (
                                <motion.span
                                    className="absolute inset-0 h-full w-full bg-accent-warm/10 dark:bg-slate-800/[0.8] block rounded-3xl"
                        ...
                        <Card>
                            <div className="w-12 h-12 rounded-xl bg-accent-warm/10 flex items-center justify-center mb-5 group-hover:bg-accent-warm/20 transition-colors z-50 relative">
